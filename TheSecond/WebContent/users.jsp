	...
	%>
					...
					<li class="nav-item dropdown user-menu"><a href="#"
						class="nav-link dropdown-toggle" data-bs-toggle="dropdown"> <img
							...
							class="d-none d-md-inline">${fullName}</span>
					</a>
									...
									<table class="table table-sm">
										...
										<tbody>
											<c:if test="${not empty userList}">
												<%-- items: ระบุ ArrayList, var: ชื่อตัวแปรสมมติในแต่ละรอบ, varStatus: เก็บสถานะการวนลูป --%>
												<c:forEach var="user" items="${userList}" varStatus="loop">
													<tr>
														...
														<td><a
															href="../update_user.jsp?userId=${user.getId()}"
