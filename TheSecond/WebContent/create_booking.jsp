...
<html lang="en">
  ...
  <head>
    ...
    <title>New Booking | The Second</title>
     	...
     	<aside class="app-sidebar bg-body-secondary shadow"
			...
			<div class="sidebar-brand">
				...
				<a href="../index.html" class="brand-link"> <!--begin::Brand Image-->
					<img src="../assets/img/meow/logo4.png" alt="Logo"
					class="brand-image opacity-75 shadow" /> <!--end::Brand Image--> <!--begin::Brand Text-->
					<span class="brand-text fw-light">The Second</span> <!--end::Brand Text-->
				</a>
          <!--end::Brand Link-->
        </div>
        <!--end::Sidebar Brand-->
        ...
        <div class="app-content-header">
          ...
          <div class="container-fluid">
                           ...
                           <%
							...
							ArrayList<Room> roomList = service.getActiveRooms();
							// เก็บลงใน Scope เพื่อให้ JSTL เรียกใช้ได้ 
            ...
            <!--begin::Row-->
            <div class="row">
              <div class="col-sm-6"><h3 class="mb-0">New Booking</h3></div>
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-end">
                  <li class="breadcrumb-item"><a href="../bookings.jsp"><i class="bi bi-book"></i> Bookings</a></li>
                </ol>
              </div>
            </div>
            <!--end::Row-->
                  ...
                  <form action="../addBooking" method="post">
                    ...
                    <div class="card-body">
                      ...
                      <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                          <input type="date" min="2025-01-01" max="2026-12-31" class="form-control" style="width: 190px" name="bookingDate" id="bookingDate">
                        </div>
                      </div>
                      ...
                      <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                          <input type="time" class="form-control" style="width: 100px" name="bookingTime" id="bookingTime">
                        </div>
                      </div>
                      ...
                      <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                          <textarea cols="80" rows="2" class="form-control" name="remark" id="note"></textarea>
                        </div>
                      </div>
