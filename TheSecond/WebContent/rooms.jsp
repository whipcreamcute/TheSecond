						...
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-end">
								...
								<li class="breadcrumb-item"><a href="../rooms.jsp">
										Rooms</a></li>
								<li class="breadcrumb-item"><a href="../create_room.jsp"><i
										class="bi bi-plus-square"></i> New Room</a></li>
							</ol>
						</div>
					</div>
					<!--end::Row-->
				...
				<div class="container-fluid">
					...
					<div class="row">
						<div class="col-12">
							...
							ArrayList<Room> roomList = service.getRooms();
							// เก็บลงใน Scope เพื่อให้ JSTL เรียกใช้ได้ 
									...
									<table class="table table-sm">
										<thead>
											<tr>
												...
												<th style="width: 90px">Room N0.</th>
												<th>Room Name</th>
													...
													<tr>
														...
														<td><c:choose>
																...
																<c:when test="${room.getStatus() == 1}">
																	<span class="badge text-bg-success">&nbsp</span>
																</c:when>

																<%-- กรณี Else If (เพิ่มกี่อันก็ได้) --%>
																<c:when test="${room.getStatus() == 0}">
																	<span class="badge text-bg-danger">&nbsp</span>
																</c:when>

																<%-- กรณี Else (ถ้าไม่เข้าเงื่อนไขข้างบนเลย) --%>
																<c:otherwise>
																	<span class="badge text-bg-default">&nbsp</span>
																</c:otherwise>
															</c:choose></td>
														<td><a
															href="../update_room.jsp?roomId=${room.getId()}"
															class="btn btn-button"><i class="bi bi-pencil-square"></i></a></td>
													</tr>
												</c:forEach>
											</c:if>
										</tbody>
