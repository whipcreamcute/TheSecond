...
<title>Update User | The Second</title>
				...
				<ul class="navbar-nav ms-auto">
					...
					<li class="nav-item dropdown user-menu"><a href="#"
						class="nav-link dropdown-toggle" data-bs-toggle="dropdown"> <img
							...
							class="d-none d-md-inline">Username</span>
					</a>
						<ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
							...
							<li class="user-header text-bg-primary"><img
								...
								alt="User Image" />
								<p>
									Username - Web Developer <small>Member since Nov. 2023</small>
								</p></li>
							<!--end::User Image-->
							<!--begin::Menu Body-->
							...
							<li class="user-footer"><a href="../profile.jsp"
								...
								href="../login.jsp" class="btn btn-default btn-flat float-end">Sign
									out</a></li>
							<!--end::Menu Footer-->
						</ul></li>
					...
					<div class="row">
						...
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-end">
								...
								<li class="breadcrumb-item"><a href="../users.jsp">
										Users</a></li>
							</ol>
						</div>
					</div>
							...
							<div class="card card-outline mb-4">
								...
								<form action="../updateUser" method="post">
									...
									<div class="card-footer">
										...
										<a href="../users.jsp" class="btn float-end">Cancel</a>
									</div>
									<!--end::Footer-->
								</form>
								<!--end::Form-->
