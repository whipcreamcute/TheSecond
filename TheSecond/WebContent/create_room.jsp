...
<html lang="en">
  ...
  <head>
    ...
    <title>New Room | The Second</title>
      ...
      <main class="app-main">
        ...
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            <!--begin::Row-->
            <div class="row">
              <div class="col-sm-6"><h3 class="mb-0">New Room</h3></div>
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-end">
                   <li class="breadcrumb-item"><a>Master Data</a></li>
                   <li class="breadcrumb-item"><a href="../rooms.jsp"> Rooms</a></li>
                </ol>
              </div>
            </div>
            <!--end::Row-->
            ...
            <div class="row">
              <div class="col-6">
                ...
                <div class="card card-outline mb-4">
                  <!--begin::Header-->
                  <div class="card-header"><div class="card-title">Room Info</div></div>
                  <!--end::Header-->
                  <!--begin::Form-->
                  <form action="../addRoom" method="post">
                    ...
                    <div class="card-body">
                      <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control" style="width: 190px" name="roomNo" id="roomNo">
                        </div>
                      </div>
                   ...
                   <fieldset class="row mb-3">
                        ...
                        <div class="col-sm-10">
                          <div class="form-check">
                            ...
                            <label class="form-check-label" for="gridRadios1"> Ready </label>
                          </div>
                          <div class="form-check">
                            <input class="form-check-input" type="radio" name="status" id="gridRadios2" value="0">
                            <label class="form-check-label" for="gridRadios2"> Not Used </label>
                          </div>
                        </div>
                      </fieldset>
